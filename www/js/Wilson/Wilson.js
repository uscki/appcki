...
angular.module('appcki.wilson',[])
	.controller("wilsonPageController", ['$scope', '$http','$location','$ionicPopup','$location','UserService','WilsonService',
        function($scope, $http, $location, $ionicPopup, $location, UserService, WilsonService){	
